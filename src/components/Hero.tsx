...
import { WHATSAPP_RAW_NUMBER, COMPANY_PHONE, BUDGET_OFFER_DETAILS } from '../data/content';
...
export default function Hero({ onOpenBookingModal }: HeroProps) {
  ...
  return (
    <section id="hero-section" className="relative min-h-[92vh] flex items-center justify-center pt-28 pb-16 overflow-hidden bg-slate-900 text-white">
      {/* Background Architectural Image with subtle overlays */}
      <div className="absolute inset-0 z-0">
        <img
          src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=2000&q=85"
          alt="Construcción y Remodelación moderna en Valparaíso"
        ...
        <div className="grid lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <p className="text-base sm:text-lg text-slate-300 max-w-2xl mx-auto lg:mx-0 font-normal leading-relaxed">
              Transformamos tu hogar utilizando los mejores materiales: <strong>Madera, Concreto, Ladrillo, Estructuras Metálicas y Paneles SIP</strong>. Nos encargamos del diseño arquitectónico, permisos y ejecución de obra completa.
            </p>

            {/* Professional Polish Experience Grid */}
            <div className="grid grid-cols-3 gap-3 max-w-lg mx-auto lg:mx-0">
              ...
              <div className="bg-slate-800/90 p-3.5 rounded-xl border border-slate-700 shadow-sm text-left">
                <p className="text-[10px] text-slate-400 uppercase font-bold tracking-wider mb-0.5">Proyectos</p>
                <p className="text-lg font-bold text-white">+140 Obras</p>
              </div>
              <div className="bg-slate-800/90 p-3.5 rounded-xl border border-slate-700 shadow-sm text-left">
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3.5">
              ...
              <a
                ...
                href={`https://wa.me/${WHATSAPP_RAW_NUMBER}?text=${encodeURIComponent(
                  'Hola! Vi su web y me interesa cotizar o agendar una visita de expertos para mi proyecto en la Región de Valparaíso.'
                )}`}
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-auto flex items-center justify-center gap-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold px-6 py-3.5 rounded-xl shadow-lg shadow-blue-900/30 transition-all active:scale-95 text-sm sm:text-base"
              >
                <MessageSquare className="w-5 h-5 fill-current" />
                <span>Cotizar al WhatsApp +56 9 9838 1384</span>
              </a>
              ...
              <button
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-2 bg-slate-800 hover:bg-slate-700 border border-slate-600 hover:border-blue-400 text-slate-200 hover:text-white font-bold px-5 py-3.5 rounded-xl transition-all shadow-sm active:scale-95 text-sm sm:text-base"
              >
                <Compass className="w-5 h-5 text-blue-400" />
                <span>Agendar Visita en Terreno ($30.000)</span>
              </button>
            </div>
            ...
            <div className="pt-3 grid grid-cols-2 sm:grid-cols-3 gap-3 text-left border-t border-slate-800">
              ...
              <div className="flex items-center gap-2 text-xs text-slate-300">
                ...
                <span>Diseño 3D en tu terreno real</span>
              </div>
              <div className="flex items-center gap-2 text-xs text-slate-300 col-span-2 sm:col-span-1">
                <ShieldCheck className="w-4 h-4 text-blue-400 shrink-0" />
                <span>Garantía Legal LGUC 10 años</span>
              </div>
            </div>

          </div>

          {/* Right Column: Featured $30.000 Budget Box Spotlight Card */}
            ...
            >
              ...
              <div className="text-center pb-4 border-b border-slate-200">
                <div className="inline-flex items-center gap-1.5 text-blue-600 text-xs font-bold uppercase tracking-wider mb-1">
                  ...
                  <span>Pack Presupuesto Pro</span>
                </div>
                ...
                <p className="text-xs text-blue-800 bg-blue-50 py-1 px-3 rounded-full inline-block font-bold mt-1">
                  Visita técnica + Asesoría + Diseño 3D
                </p>
              </div>
              ...
              <div className="py-4 space-y-3">
                <ul className="space-y-3 text-xs text-slate-700">
                  ...
                  <li className="flex items-start gap-2.5">
                    <CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0 mt-0.5" />
                    <span><strong>Asesoría Técnica:</strong> Definimos la mejor solución estructural, materiales y distribución.</span>
                  </li>

                  <li className="flex items-start gap-2.5">
                    <CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0 mt-0.5" />
                    <span><strong>Diseño e Imágenes 3D:</strong> Visualiza exactamente cómo quedará tu propiedad terminada.</span>
                  </li>
              ...
              >
                <span>Agendar mi Visita & Diseño por $30.000</span>
              ...
              <div className="mt-3 text-center">
                <a
                  href={`https://wa.me/${WHATSAPP_RAW_NUMBER}?text=${encodeURIComponent(
                    'Hola, me gustaría agendar la visita en terreno de $30.000 con diseño 3D.'
                  )}`}
                  target="_blank"
                  rel="noopener noreferrer"
